				...
				<a href="#">
					<div class="d-flex flex-row align-items-center justify-content-start">
						<div class="footer_logo_icon">
							<img height="100"src="<?= base_url('assets/images/trecora.png') ?>">
						</div>
						<div>TRECORA</div>
					</div>
				</a>		
			</div>
			<div class="footer_about_text"></p>
			</div>
		</div>
	</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/Robbyzhg" target="_blank">Robby Zhang</a>
